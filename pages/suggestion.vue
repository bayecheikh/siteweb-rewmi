<template>
    <div id="main-wrapper" class="main-wrapper">
        ...
        <BreadCrumbTwo title='Faire une suggestion' />
                            ...
                            <div class="inner">
                                ...
                                <div class="contact-us-info">
                                    ...
                                    <ul class="social-share">
                                        <li><n-link to=""><i class="icon-facebook"></i></n-link></li>
                                        <li><n-link to=""><i class="icon-linkedin2"></i></n-link></li>
                                        <li><n-link to=""><i class="icon-instagram"></i></n-link></li>
                                        <li><n-link to=""><i class="icon-twitter"></i></n-link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="contact-form">
                            <div class="section-title section-center">
                                <h3 class="title">Envoyez votre suggestion</h3>
                            </div>
