            ...
            <div class=" row g-5">
                <div class="col-12 col-lg-3 col-md-6 col-sm-6">
                    <div class="edu-counterup counterup-style-6">
                        <div class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="54.739" height="55.295" viewBox="0 0 54.739 55.295">
  <g id="Groupe_7574" data-name="Groupe 7574" transform="translate(0.25 0.25)">
    <path id="Tracé_3635" data-name="Tracé 3635" d="M29.123-15.19a8.174,8.174,0,0,0,3.635-6.751v-3.514A8.083,8.083,0,0,0,24.65-33.5a8.083,8.083,0,0,0-8.108,8.045v3.514a8.3,8.3,0,0,0,3.635,6.751A11.556,11.556,0,0,0,13-4.555V5.895A1.073,1.073,0,0,0,14.118,7h20.97a1.073,1.073,0,0,0,1.118-1.11V-4.555A11.425,11.425,0,0,0,29.123-15.19ZM18.778-21.848v-3.514a5.825,5.825,0,0,1,5.872-5.826,5.825,5.825,0,0,1,5.871,5.826v3.514a5.824,5.824,0,0,1-5.871,5.826A5.884,5.884,0,0,1,18.778-21.848ZM33.97,4.785H15.237V-4.463a9.31,9.31,0,0,1,8.2-9.155v9.155a1.073,1.073,0,0,0,1.118,1.11,1.073,1.073,0,0,0,1.118-1.11v-9.155a9.232,9.232,0,0,1,8.2,9.155V4.785Z" transform="translate(2.533 47.79)" fill="#fff" stroke="#fff" stroke-width="0.5" fill-rule="evenodd"/>
    <path id="Tracé_3636" data-name="Tracé 3636" d="M40.882-26.69a8.208,8.208,0,0,0,3.577-6.751v-3.514A8.019,8.019,0,0,0,36.48-45a8.018,8.018,0,0,0-7.98,8.046v3.514a8.086,8.086,0,0,0,3.485,6.658,9.2,9.2,0,0,0-1.376.647,1.19,1.19,0,0,0-.459,1.572,1.17,1.17,0,0,0,1.559.462,12.047,12.047,0,0,1,4.769-1.2,9.237,9.237,0,0,1,9.172,9.248v9.247H36.48a1.064,1.064,0,0,0-1.1,1.11,1.064,1.064,0,0,0,1.1,1.11H46.844a1.064,1.064,0,0,0,1.1-1.11v-10.45A11.427,11.427,0,0,0,40.882-26.69ZM30.7-33.44v-3.514A5.778,5.778,0,0,1,36.48-42.78a5.778,5.778,0,0,1,5.778,5.826v3.514a5.778,5.778,0,0,1-5.778,5.826A5.778,5.778,0,0,1,30.7-33.44Z" transform="translate(6.294 45)" fill="#fff" stroke="#fff" stroke-width="0.5" fill-rule="evenodd"/>
    <path id="Tracé_3637" data-name="Tracé 3637" d="M11.965-6.807H2.793v-9.247A9.237,9.237,0,0,1,11.965-25.3a9.936,9.936,0,0,1,4.769,1.2,1.2,1.2,0,0,0,1.559-.462,1.217,1.217,0,0,0-.458-1.572,9.214,9.214,0,0,0-1.376-.647,8.085,8.085,0,0,0,3.485-6.658v-3.514A8.018,8.018,0,0,0,11.965-45a8.018,8.018,0,0,0-7.98,8.046v3.514A8.338,8.338,0,0,0,7.562-26.69,11.556,11.556,0,0,0,.5-16.055v10.45A1.064,1.064,0,0,0,1.6-4.5H11.965a1.064,1.064,0,0,0,1.1-1.11A1.207,1.207,0,0,0,11.965-6.807ZM6.187-33.44v-3.514a5.778,5.778,0,0,1,5.778-5.826,5.778,5.778,0,0,1,5.778,5.826v3.514a5.778,5.778,0,0,1-5.778,5.826A5.778,5.778,0,0,1,6.187-33.44Z" transform="translate(-0.5 45)" fill="#fff" stroke="#fff" stroke-width="0.5" fill-rule="evenodd"/>
  </g>
</svg>
                ...
                <div class="col-12 col-lg-3 col-md-6 col-sm-6">
                    <div class="edu-counterup counterup-style-6">
                        <div class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="73.969" height="51.098" viewBox="0 0 73.969 51.098">
